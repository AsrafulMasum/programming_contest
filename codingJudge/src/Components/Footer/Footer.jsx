    ...
    <div className="bg-white">
      <footer className="footer footer-center pt-10 text-base-content bg-secondary-color">
            ...
            <div className="grid grid-flow-col gap-8">
              ...
              <a>
                <svg
                  ...
                  height="24"
                  viewBox="0 0 24 24"
                  className="fill-current cursor-pointer text-active-color"
                >
        ...
        <nav className="flex justify-center items-center flex-wrap gap-8 text-white px-4 text-base">
          {navItems}{" "}
          {/* Render the navigation links dynamically based on the user's role */}
        </nav>
        ...
        <aside className="bg-secondary-color w-full h-16 flex justify-center items-start">
          <p className="text-white">
            ...
            <span className="text-active-color font-semibold">Code Forge</span>{" "}
            Ltd
          </p>
        </aside>
      </footer>
